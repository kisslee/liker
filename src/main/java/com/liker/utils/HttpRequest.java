...
public class HttpRequest {
	...
	static Logger logger = Logger. getLogger("HttpRequest");
...
//            logger.log(Level.INFO, "result--->" + result);
            System.out.println("--请求结果--result:" + result);
        } catch (Exception e) {
            logger.log(Level.INFO, "发送GET请求出现异常！" + e);
            e.printStackTrace();
        }
        // 使用finally块来关闭输入流
        finally {
...
//            System.out.println("发送 POST 请求出现异常！"+e);
    ...
    public static void main(String[] args) {
		...
		System.out.println(result.indexOf("查询结果"));
